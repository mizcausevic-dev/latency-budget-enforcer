...
### Released
- Released **latency-budget-enforcer** publicly as a reviewable operating system for ai retrieval reliability.
...
### Shipped
- Cut the first coherent internal version of **latency-budget-enforcer** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: Go policy engine for latency budget enforcement, dependency drag review, tail-latency breaches, and operator-facing service-path response planning
